...
SUBROUTINE green(wc,gout_ad)
 ...
 COMPLEX(double), DIMENSION(dimG,dimG) :: g0Pristine
 ...
 g0i_B = g0i_A
 g0Pristine = wc*mum - g0i_A
 CALL invers(g0Pristine,dimG)
 ...
 ! flake at the right.
 ! In this version, instead of the pristine flake we add
 ! flake with an unpolarized adatom.


 g0AA = g0i_A - MATMUL(HBA,MATMUL(g0Pristine,HAB))
 g0BB = g0i_B - MATMUL(HAB,MATMUL(g0Pristine,HBA))
