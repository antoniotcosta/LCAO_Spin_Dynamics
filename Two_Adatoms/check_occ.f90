...
PROGRAM Self_Bismuthene_with_adatoms
 ...
 EXTERNAL fcn
  ...
  OPEN(unit=99,file='check_entrada.in',status='old')
  ...
  X(1:Nadatoms) = 0d0
  X(Nadatoms+1:2*Nadatoms) = 0d0
  X(2*Nadatoms+1:3*Nadatoms) = 0d0
  X(3*Nadatoms+1:4*Nadatoms) = 0d0
