SUBROUTINE wd_Int_chi0(e,chi_hf)
 ...
 COMPLEX(double), DIMENSION(4*5*5*Nadtotal,5*5*Nadtotal), INTENT(OUT) :: chi_hf
 ...
 COMPLEX(double), DIMENSION(4*5*5*Nadtotal,5*5*Nadtotal) :: Fint

 INTEGER :: IERR,NCOUNT=4*5*5*5*5*Nadtotal*Nadtotal
