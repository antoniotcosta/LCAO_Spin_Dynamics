...
! IF (myid==0) WRITE(*,*)"dimH",dimh
 ...
 Hllc(1:dimH_p3,Nadatoms*Norb_ad+1:dimH) = H01_pristine
 Hllc(dimH_p3+1:2*dimH_p3,dimH+Nadatoms*Norb_ad+1:dimG) = H01_pristine
 Hcll = TRANSPOSE(Hllc)

 Hcrl = CMPLX(0d0,0d0,double)
 Hcrl(Nadatoms*Norb_ad+1:dimH,1:dimH_p3) = H01_pristine 
 Hcrl(dimH+Nadatoms*Norb_ad+1:dimG,dimH_p3+1:2*dimH_p3) = H01_pristine 
 Hrlc = TRANSPOSE(Hcrl)
