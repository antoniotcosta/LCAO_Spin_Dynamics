SUBROUTINE dchi_HF_1(w,csi,chi0m)
 ...
 USE lattice
  ...
  COMPLEX(double), DIMENSION(4*5*5*Nadtotal,4*5*5*Nadtotal), INTENT(OUT) :: chi0m
  ...
  DO nu = 1,5
  DO nul = 1,5
  n = (ll-1)*25*Nadtotal + (js-1)*25 + (nu-1)*5 + nul
  ...
  ! s2_s3 * s4_s1
  ! s1_s4 * s3_s2
  chi0m(m,n) = g_dnup(1,is,js,nu+4,mul+4)*g_upup(2,js,is,nul+4,mu+4) + &
               CONJG(g_upup(3,is,js,mu+4,nul+4)*g_updn(2,js,is,mul+4,nu+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_upup(1,is,js,nu+4,mul+4)*g_upup(2,js,is,nul+4,mu+4) + &
               CONJG(g_upup(3,is,js,mu+4,nul+4)*g_upup(2,js,is,mul+4,nu+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_dnup(1,is,js,nu+4,mul+4)*g_updn(2,js,is,nul+4,mu+4) + &
               CONJG(g_dnup(3,is,js,mu+4,nul+4)*g_updn(2,js,is,mul+4,nu+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_upup(1,is,js,nu+4,mul+4)*g_updn(2,js,is,nul+4,mu+4) + &
               CONJG(g_dnup(3,is,js,mu+4,nul+4)*g_upup(2,js,is,mul+4,nu+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_dndn(1,is,js,nu+4,mul+4)*g_dnup(2,js,is,nul+4,mu+4) + &
               CONJG(g_updn(3,is,js,mu+4,nul+4)*g_dndn(2,js,is,mul+4,nu+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_updn(1,is,js,nu+4,mul+4)*g_dnup(2,js,is,nul+4,mu+4) + &
               CONJG(g_updn(3,is,js,mu+4,nul+4)*g_dnup(2,js,is,mul+4,nu+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_dndn(1,is,js,nu+4,mul+4)*g_dndn(2,js,is,nul+4,mu+4) + &
               CONJG(g_dndn(3,is,js,mu+4,nul+4)*g_dndn(2,js,is,mul+4,nu+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_updn(1,is,js,nu+4,mul+4)*g_dndn(2,js,is,nul+4,mu+4) + &
               CONJG(g_dndn(3,is,js,mu+4,nul+4)*g_dnup(2,js,is,mul+4,nu+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_dnup(1,is,js,nu+4,mul+4)*g_dnup(2,js,is,nul+4,mu+4) + &
               CONJG(g_updn(3,is,js,mu+4,nul+4)*g_updn(2,js,is,mul+4,nu+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_upup(1,is,js,nu+4,mul+4)*g_dnup(2,js,is,nul+4,mu+4) + &
               CONJG(g_updn(3,is,js,mu+4,nul+4)*g_upup(2,js,is,mul+4,nu+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_dnup(1,is,js,nu+4,mul+4)*g_dndn(2,js,is,nul+4,mu+4) + &
               CONJG(g_dndn(3,is,js,mu+4,nul+4)*g_updn(2,js,is,mul+4,nu+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_upup(1,is,js,nu+4,mul+4)*g_dndn(2,js,is,nul+4,mu+4) + &
               CONJG(g_dndn(3,is,js,mu+4,nul+4)*g_upup(2,js,is,mul+4,nu+4))
  END DO
  END DO
  END DO
  END DO
...
!  n = (ll-1)*25*Nadtotal + (js-1)*25 + (nu-1)*5 + nul
!
!  chi0m(m,n) = g_s2s3(1,is,js,nu+4,mul+4)*g_s4s1(2,js,is,nul+4,mu+4) + &
!               CONJG(g_s1s4(3,is,js,mu+4,nul+4)*g_s3s2(2,js,is,mul+4,nu+4))
!  END DO
!  END DO
!  END DO
!  END DO
...
SUBROUTINE dchi_HF_2(w,csi,chi0m)
 ...
 USE lattice
  ...
  chi0m(m,n) = g_dnup(1,is,js,nu+4,mul+4)*CONJG(g_upup(2,is,js,mu+4,nul+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_upup(1,is,js,nu+4,mul+4)*CONJG(g_upup(2,is,js,mu+4,nul+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_dnup(1,is,js,nu+4,mul+4)*CONJG(g_dnup(2,is,js,mu+4,nul+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_upup(1,is,js,nu+4,mul+4)*CONJG(g_dnup(2,is,js,mu+4,nul+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_dndn(1,is,js,nu+4,mul+4)*CONJG(g_updn(2,is,js,mu+4,nul+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_updn(1,is,js,nu+4,mul+4)*CONJG(g_updn(2,is,js,mu+4,nul+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_dndn(1,is,js,nu+4,mul+4)*CONJG(g_dndn(2,is,js,mu+4,nul+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_updn(1,is,js,nu+4,mul+4)*CONJG(g_dndn(2,is,js,mu+4,nul+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_dnup(1,is,js,nu+4,mul+4)*CONJG(g_updn(2,is,js,mu+4,nul+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_upup(1,is,js,nu+4,mul+4)*CONJG(g_updn(2,is,js,mu+4,nul+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_dnup(1,is,js,nu+4,mul+4)*CONJG(g_dndn(2,is,js,mu+4,nul+4))
  END DO
  END DO
  END DO
  END DO
  ...
  chi0m(m,n) = g_upup(1,is,js,nu+4,mul+4)*CONJG(g_dndn(2,is,js,mu+4,nul+4))
  END DO
  END DO
  END DO
  END DO
